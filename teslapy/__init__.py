...
#from .. logger import logger as lo
...
class Vehicle(JsonDict):
    ...
    def last_seen(self):
        ...
        if diff < 0:
            return "{:.2f}".format(diff) +'s in the future'
            #raise ValueError('Timestamp is ' + diff +'in the future')
        if diff >= 1:
    ...
    def decode_vin(self):
        ...
        body = {'A': 'Hatch back 5 Dr / LHD',
                'B': 'Hatch back 5 Dr / RHD',
                'C': 'Class E MPV / 5 Dr / LHD',
                'E': 'Sedan 4 Dr / LHD',
                'D': 'Class E MPV / 5 Dr / RHD',
                'F': 'Sedan 4 Dr / RHD',
        ...
        drive = {'1': 'Single Motor - Standard',
                 ...
                 'P': 'Performance, Tier 7',
                 'G': 'Base, Tier 4',
                 'N': 'Base, Tier 7'
                 }.get(self['vin'][7], 'Unknown')
        year = 2009 + '9ABCDEFGHJKLMNPRSTVWXY12345678'.index(self['vin'][9])
        plant = {'1': 'Menlo Park, CA, USA',
                 '3': 'Hethel, UK',
                 'B': 'Berlin, Germany',
                 'C': 'Shanghai, China',
                 'F': 'Fremont, CA, USA',
